...
| **김범준** | 팀원   | - 예산 등록/조회/수정 기능 구현<br>- 사용자별 예산 소비내역 관리 API 개발                                                                              |
| **이지수** | 팀원   | - 음식점 정보 조회/등록/검색 기능 구현<br>- 태그 기반 음식점 점수 계산 로직 개발                                                                           |
| **전가람** | 팀원   | - 회원가입 및 로그인 기능 구현<br>- 사용자 인증 및 권한 처리<br>- 회원정보 관리 기능 구현                                                                    |
