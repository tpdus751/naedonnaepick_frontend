...
이름	역할	담당 업무
박세연	팀장
(Fullstack)	- 프로젝트 전체 코드 통합 및 구조 설계
- 추천 모델 개발 (Random Forest)
- 감성 분석 모델 개발 (KcELECTRA)
- 실시간 채팅 기능 구현
- 전체 문서화 및 README 관리
김범준	팀원
(Backend)	- 예산 등록/조회/수정 기능 구현
- 사용자별 예산 소비내역 관리 API 개발
이지수	팀원
(Backend)	- 음식점 정보 조회/등록/검색 기능 구현
- 태그 기반 음식점 점수 계산 로직 개발
전가람	팀원
(Backend)	- 회원가입 및 로그인 기능 구현
- 사용자 인증 및 권한 처리
- 회원정보 관리 기능 구현
